...
function Markup() {
    ...
    return (
        <svg ref={allRef} style={{ height: '60rem', fill: 'rgb(1, 97, 239)', zIndex: '1', alignItems: "center", flexGrow: '0', justifyContent: "center", justifyItems: "center" }} width="800" height="800" viewBox="0 0 523 523" xmlns="http://www.w3.org/2000/svg">
