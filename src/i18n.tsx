        ...
        resources: {
            en: {
                translation: {
                    ...
                    "HeaderDescriptionTwo": "specializing in Mobile & XR apps",
                    "AboutMe": "About Me",
                    ...
                    "AboutMeDescriptionTwo": "On a daily basis, I work as a Mobile Developer, creating mobile applications for Android and iOS using the Flutter framework. I also work on XR applications for Apple's Vision Pro device and Meta.",
                    "AboutMeDescriptionThree": "You can find more information about me below:",
                    "GoodsoftJobDescription": "Responsible for building cross-platform and native applications using Flutter or Kotlin with Jetpack Compose. I am implementing features such as video-based object recognition with YOLO and TensorFlow Lite, XR experiences for Vision Pro using ARKit/RealityKit, and CI/CD pipelines. My work is including advanced navigation, map rendering, Firebase and AdMob integration, Clean Architecture patterns, as well as offline data management with SQFLite. I am maintaining high code quality by generating boilerplate with Freezed and build_runner, and by defining custom linting rules.",
